 ...
 */
public class FieldQParserPluginPatch extends QParserPlugin {
  @Override
  public QParser createParser(
    ...
    return new QParser(qstr, localParams, params, req) {
      ...
      public Query parse() {
        ...
        return query != null ? query : new MatchNoDocsQuery();
      }

      private Query parseQuery() {
        final String field = localParams.get(QueryParsing.F);
        final String queryText = localParams.get(QueryParsing.V);
